...
STORE avg_2008 INTO '/user/s31wcp55/id2008_avg' USING PigStorage (',');
STORE max_2008 INTO '/user/s31wcp55/id2008_max' USING PigStorage (',');
...
STORE avg_2007 INTO '/user/s31wcp55/id2007_avg' USING PigStorage (',');
STORE max_2007 INTO '/user/s31wcp55/id2007_max' USING PigStorage (',');
...
STORE avg_2006 INTO '/user/s31wcp55/id2006_avg' USING PigStorage (',');
STORE max_2006 INTO '/user/s31wcp55/id2006_max' USING PigStorage (',');
...
STORE avg_2005 INTO '/user/s31wcp55/id2005_avg' USING PigStorage (',');
STORE max_2005 INTO '/user/s31wcp55/id2005_max' USING PigStorage (',');
...
STORE avg_2004 INTO '/user/s31wcp55/id2004_avg' USING PigStorage (',');
STORE max_2004 INTO '/user/s31wcp55/id2004_max' USING PigStorage (',');
...
STORE avg_2003 INTO '/user/s31wcp55/id2003_avg' USING PigStorage (',');
STORE max_2003 INTO '/user/s31wcp55/id2003_max' USING PigStorage (',');
...
STORE avg_2002 INTO '/user/s31wcp55/id2002_avg' USING PigStorage (',');
STORE max_2002 INTO '/user/s31wcp55/id2002_max' USING PigStorage (',');
...
STORE avg_2001 INTO '/user/s31wcp55/id2001_avg' USING PigStorage (',');
STORE max_2001 INTO '/user/s31wcp55/id2001_max' USING PigStorage (',');
...
STORE avg_2000 INTO '/user/s31wcp55/id2000_avg' USING PigStorage (',');
STORE max_2000 INTO '/user/s31wcp55/id2000_max' USING PigStorage (',');
...
STORE avg_1999 INTO '/user/s31wcp55/id1999_avg' USING PigStorage (',');
STORE max_1999 INTO '/user/s31wcp55/id1999_max' USING PigStorage (',');
...
STORE avg_1998 INTO '/user/s31wcp55/id1998_avg' USING PigStorage (',');
STORE max_1998 INTO '/user/s31wcp55/id1998_max' USING PigStorage (',');
...
STORE avg_1997 INTO '/user/s31wcp55/id1997_avg' USING PigStorage (',');
STORE max_1997 INTO '/user/s31wcp55/id1997_max' USING PigStorage (',');
...
STORE avg_1996 INTO '/user/s31wcp55/id1996_avg' USING PigStorage (',');
STORE max_1996 INTO '/user/s31wcp55/id1996_max' USING PigStorage (',');
...
STORE avg_1995 INTO '/user/s31wcp55/id1995_avg' USING PigStorage (',');
STORE max_1995 INTO '/user/s31wcp55/id1995_max' USING PigStorage (',');
...
STORE avg_1994 INTO '/user/s31wcp55/id1994_avg' USING PigStorage (',');
STORE max_1994 INTO '/user/s31wcp55/id1994_max' USING PigStorage (',');
...
STORE avg_1993 INTO '/user/s31wcp55/id1993_avg' USING PigStorage (',');
STORE max_1993 INTO '/user/s31wcp55/id1993_max' USING PigStorage (',');
...
STORE avg_1992 INTO '/user/s31wcp55/id1992_avg' USING PigStorage (',');
STORE max_1992 INTO '/user/s31wcp55/id1992_max' USING PigStorage (',');
...
STORE avg_1991 INTO '/user/s31wcp55/id1991_avg' USING PigStorage (',');
STORE max_1991 INTO '/user/s31wcp55/id1991_max' USING PigStorage (',');
...
STORE avg_1990 INTO '/user/s31wcp55/id1990_avg' USING PigStorage (',');
STORE max_1990 INTO '/user/s31wcp55/id1990_max' USING PigStorage (',');
...
STORE avg_1989 INTO '/user/s31wcp55/id1989_avg' USING PigStorage (',');
STORE max_1989 INTO '/user/s31wcp55/id1989_max' USING PigStorage (',');
...
STORE avg_1988 INTO '/user/s31wcp55/id1988_avg' USING PigStorage (',');
STORE max_1988 INTO '/user/s31wcp55/id1988_max' USING PigStorage (',');
...
STORE avg_1987 INTO '/user/s31wcp55/id1987_avg' USING PigStorage (',');
STORE max_1987 INTO '/user/s31wcp55/id1987_max' USING PigStorage (',');
